...
{
    if(input.parentElement.classList[0]!=="special-attribute" && input.nextElementSibling)
    {
        let notification=input.nextElementSibling;
        notification.remove();
    }

    if(input.parentElement.classList[0]=="special-attribute" && input.previousElementSibling.childNodes[1])
    {
